...
@ApiTags('PatientsAnswers')
@Controller('/api/v1/patients-answers')
@ApiExtraModels(PageOutput<PatientAnswerOutput>)
@UseGuards(RolesGuard)
export class PatientAnswerController {
  constructor(
    private readonly service: PatientAnswerService,
    private readonly mapper: PatientAnswerMapper,
  ) {}
  ...
  async create(
    @Body() input: CreatePatientAnswer,
  ): Promise<PatientAnswerOutput> {
  ...
  @Get()
  @ApiBearerAuth()
  @ApiPageResponse(PatientAnswerOutput)
  @ApiException(() => [BadRequestException])
  public async list(
    @Query() criteria: SearchPatientAnswer,
  ): Promise<PageOutput<PatientAnswerOutput>> {
  ...
  ): Promise<PageOutput<AuditOutput<PatientAnswerOutput>>> {
  ...
  async update(
    ...
    @Body() input: UpdatePatientAnswer,
  ): Promise<PatientAnswerOutput> {
  ...
  public async remove(
    ...
    return { message: 'PatientAnswer deleted' };
  }
  ...
  async permanentDelete(
    ...
    return { message: 'PatientAnswer permanently deleted' };
  }
