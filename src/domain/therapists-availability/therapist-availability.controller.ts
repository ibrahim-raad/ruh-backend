...
export class TherapistAvailabilityController {
  ...
  @Get()
  @ApiBearerAuth()
  @ApiPageResponse(TherapistAvailabilityOutput)
  @ApiException(() => [BadRequestException])
  public async list(
    @Query() criteria: SearchTherapistAvailability,
  ): Promise<PageOutput<TherapistAvailabilityOutput>> {
  ...
  ): Promise<PageOutput<AuditOutput<TherapistAvailabilityOutput>>> {
  ...
  async update(
    ...
    @Body() input: UpdateTherapistAvailability,
